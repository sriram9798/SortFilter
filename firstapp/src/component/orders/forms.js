                ...
                <div className="panel panel-primary">
                    ...
                    <div className="panel-body">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="address" className="form-control" value={this.state.address} onChange={this.handleChangeAddress} />
                        </div>

                        <div className="form-group">
                            <label className="control-label">No. of Person</label>
                            <select name="person" className="form-control" value={this.state.person} onChange={this.handleChangePerson}>
